...
const ResultPage = () => {
  ...
  useEffect(() => {
    ...
    if (totalScore >= 80) setDementiaLevel("Low risk of dementia");
    else if (totalScore >= 50) setDementiaLevel("Moderate risk of dementia");
    else setDementiaLevel("High risk of dementia");
  }, [scores]);
  ...
  return (
    <div className="min-h-screen flex flex-col bg-gray-100">
      ...
      <main className="flex flex-col items-center flex-grow py-12 px-4 md:px-20">
        <h1 className="text-4xl font-bold mb-10 text-gray-900 text-center">Test Results</h1>

        <div className="w-full max-w-xl bg-white rounded-lg shadow-md p-6 mb-10">
          <h2 className="text-2xl font-semibold mb-6">Scores</h2>

          <div className="mb-4">
            <p className="mb-1 font-medium">Speech Test: {scores.speechScore}/100</p>
          ...
          <div className="mb-4">
            <p className="mb-1 font-medium">Memory Game: {scores.memoryScore}/100</p>
            <div className="w-full h-6 bg-gray-300 rounded-full">
          ...
          <div className="mb-4">
            <p className="mb-1 font-medium">Cue Card Game: {scores.cueCardScore}/100</p>
            <div className="w-full h-6 bg-gray-300 rounded-full">
          ...
          <div className="mt-6 p-4 bg-gray-100 rounded-lg text-center">
            <p className="text-xl font-semibold mb-2">Overall Score: {overallScore}/100</p>

    ...
    <div className="min-h-screen flex flex-col bg-gray-50">
      ...
      <main className="flex flex-col items-center flex-grow py-20 px-4 md:px-20">
        <h1 className="text-4xl font-bold mb-4 text-gray-900 text-center">
          Speech Test - Tell About Yourself
        </h1>
        <p className="text-gray-600 mb-10 text-center max-w-xl">
            
          Speak clearly when prompted. The test will analyze your words for memory and clarity. Click “Start Speaking” to begin.
        </p>
        ...
        <div className="flex flex-col items-center mb-8">
          ...
          <span className="mt-4 text-gray-700 font-medium">
            {speaking ? "Listening..." : "Click to speak"}
          </span>
        </div>

...
const CueCardGame = () => {
  ...
  // Sequence of words for the user to remember
  const sequence = ["Apple", "Dog", "Banana", "Chair", "Orange", "Book"];
    ...
    <div className="min-h-screen flex flex-col bg-gray-100">
      ...
      <main className="flex flex-col items-center flex-grow py-12 px-4 md:px-20">
        ...
        <p className="text-gray-700 mb-6 text-center">
          Memorize the sequence of words. You have 5 seconds to view it.
        </p>
        ...
        {!showSequence && (
          <>
            <p className="mb-4 text-gray-800 font-semibold">Click the cards in the correct order:</p>
            <div className="flex flex-wrap gap-4 justify-center mb-6">
            ...
            <div className="mb-4">
              <strong>Your sequence:</strong> {userSequence.join(", ")}
            </div>
